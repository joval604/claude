        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Novartis AD HIT 2026 · July 14 Interview</p>
            </div>
          ...
          <div className="mt-3 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
            <p className="text-xs text-amber-800 font-medium text-center italic leading-relaxed">
